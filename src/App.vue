      ...
      <div class="non-footer-content">
        ...
        >
          ...
          <app-timed
            ...
            v-if="$route.params.gameType == 'Timed' && $route.params.roomID"
          ></app-timed>
          <app-shuffled
            ref="shuffled"
            :roomID="$route.params.roomID"
            ...
            v-if="$route.params.gameType == 'Shuffled' && $route.params.roomID"
          ></app-shuffled>
          <app-monster
            :roomID="$route.params.roomID"
            :gSheetID="$route.params.gSheetID"
            v-if="$route.params.gameType == 'Monster' && $route.params.roomID"
          ></app-monster>
          <app-secretCards
            :roomID="$route.params.roomID"
            :gSheetID="$route.params.gSheetID"
            v-if="
              $route.params.gameType == 'SecretCards' && $route.params.roomID
            "
          ></app-secretCards>
          <app-slotMachine
            :roomID="$route.params.roomID"
            :gSheetID="$route.params.gSheetID"
            v-if="
              ($route.params.gameType == 'SlotMachine' ||
                $route.params.gameType == 'Composite') &&
              $route.params.roomID
            "
          ></app-slotMachine>
          <app-phases
            :roomID="$route.params.roomID"
            :gSheetID="$route.params.gSheetID"
            v-if="$route.params.gameType == 'Phases' && $route.params.roomID"
          ></app-phases>
          <app-generator
            :roomID="$route.params.roomID"
            :gSheetID="$route.params.gSheetID"
            v-if="$route.params.gameType == 'Generator' && $route.params.roomID"
          ></app-generator>
          <app-hexflower
            :roomID="$route.params.roomID"
            :gSheetID="$route.params.gSheetID"
            v-if="$route.params.gameType == 'Hexflower' && $route.params.roomID"
          ></app-hexflower>
          <app-gridmap
            :roomID="$route.params.roomID"
            :gSheetID="$route.params.gSheetID"
            v-if="$route.params.gameType == 'Gridmap' && $route.params.roomID"
          ></app-gridmap>
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          property: "og:image",
          content:
            "https://i1.wp.com/amble.studio/wp-content/uploads/2020/12/Amble-Brandmark.png?resize=1880%2C1581&ssl=1",
          vmid: "og:image",
        },
        {
          property: "og:url",
